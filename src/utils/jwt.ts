...
export const generateRefreshToken = (userId: number) => {
  // Refresh token with the userId payload, secret from env variables, and expiration time of 4 hours
  return jwt.sign({ userId }, process.env.REFRESH_SECRET as string, { expiresIn: "4h" });
};